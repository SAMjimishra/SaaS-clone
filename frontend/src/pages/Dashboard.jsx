...
import {
  Shield, Activity, Clock, Zap, TrendingUp, TrendingDown,
  ShieldAlert, ServerCog, Target, ScanLine, BrainCircuit,
  Radio, Cpu,
} from 'lucide-react';
        ...
        >
          <div style={{ flex: '1', minWidth: '280px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 6 }}>
              ...
              <h1 style={{ fontSize: 'calc(1.2rem + 1vw)', fontWeight: 900, letterSpacing: '-0.04em', color: 'var(--text)', margin: 0 }}>
          ...
          <div style={{ textAlign: 'right', flexShrink: 0 }}>
            ...
            <div style={{ fontSize: '18px', fontWeight: 800, fontFamily: "'JetBrains Mono'", color: 'var(--text)', whiteSpace: 'nowrap' }}>
