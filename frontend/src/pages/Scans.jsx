...
import {
  ScanLine, Search, Wifi, Globe, Shield,
  Loader2, CheckCircle2, AlertTriangle, List,
  ExternalLink, Trash2, Clock, Mail, Users,
    ...
    <Layout>
      ...
      <div className="dark-card p-6 mb-6 bg-[var(--bg2)] border border-[var(--border)] rounded-xl">
        <div className="flex flex-col lg:flex-row gap-4 items-center lg:items-end">
          <div className="w-full lg:min-w-[320px] lg:max-w-[450px] flex-1">
          ...
          <div className="w-full flex items-center gap-3 font-bold overflow-x-auto pb-2 px-1" style={{ scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch' }}>
            <button 
              onClick={() => handleStartScan('subdomain')}
              disabled={loading || currentScanId}
              className="px-4 py-2.5 bg-cyan-600/20 text-cyan-400 border border-cyan-500/30 rounded-lg hover:bg-cyan-600/30 flex items-center gap-2 transition-all disabled:opacity-50 whitespace-nowrap shrink-0"
            >
            ...
            <button 
              ...
              disabled={loading || currentScanId}
              className="px-4 py-2.5 bg-indigo-600/20 text-indigo-400 border border-indigo-500/30 rounded-lg hover:bg-indigo-600/30 flex items-center gap-2 transition-all disabled:opacity-50 whitespace-nowrap shrink-0"
            >
            ...
            <button 
              ...
              disabled={loading || currentScanId}
              className="px-4 py-2.5 bg-emerald-600/20 text-emerald-400 border border-emerald-500/30 rounded-lg hover:bg-emerald-600/30 flex items-center gap-2 transition-all disabled:opacity-50 whitespace-nowrap shrink-0"
            >
            ...
            <button 
              ...
              disabled={loading || currentScanId}
              className="px-4 py-2.5 bg-rose-600/20 text-rose-400 border border-rose-500/30 rounded-lg hover:bg-rose-600/30 flex items-center gap-2 transition-all disabled:opacity-50 whitespace-nowrap shrink-0"
            >
